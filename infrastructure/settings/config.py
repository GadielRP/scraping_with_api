...
class Config:
    ...
    INTRADAY_RESULT_FRESHNESS_TRACKED_COMPETITIONS_ONLY = _parse_env_bool_alias(
        'INTRADAY_RESULT_FRESHNESS_TRACKED_COMPETITIONS_ONLY',
        'INTRADAY_FRESHNESS_TRACKED_COMPETITIONS_ONLY',
        True,
    )
    TIMESTAMP_CORRECTIONS_TRACKED_COMPETITIONS_ONLY = _parse_env_bool_alias(
        'TIMESTAMP_CORRECTIONS_TRACKED_COMPETITIONS_ONLY',
    ...
    ODDS_EXTRACTION_GENERAL_TRACKED_COMPETITIONS_ONLY = _parse_env_bool_alias(
        'ODDS_EXTRACTION_GENERAL_TRACKED_COMPETITIONS_ONLY',
        'ODDS_EXTRACTION_TRACKED_COMPETITIONS_ONLY',
        True,
    )
    ODDS_EXTRACTION_SOFASCORE_TRACKED_COMPETITIONS_ONLY = _parse_env_bool(
        'ODDS_EXTRACTION_SOFASCORE_TRACKED_COMPETITIONS_ONLY',
        True,
    )
    ODDS_EXTRACTION_ODDSPAPI_TRACKED_COMPETITIONS_ONLY = _parse_env_bool(
